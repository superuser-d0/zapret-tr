...
> **Ayrıntılı belge.** Yalnızca kurup kullanmak istiyorsanız [kısa rehber](README.md) yeterli.
> Bu sayfa nasıl çalıştığını, ölçüm sonuçlarını ve geliştirme bilgilerini merak edenler için.

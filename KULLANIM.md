...
# ZapretTR — Kısa Kullanım Rehberi

**Türkiye'deki erişim engellerini aşan ayarı sizin hattınızda ölçerek bulan Windows uygulaması.**

### [⬇ İndir](https://github.com/superuser-d0/zapret-tr/releases/latest) · [Sorun giderme](docs/SORUN-GIDERME.md) · [Ayrıntılı README](README.md)
...
sonuçları ve geliştirme bilgileri [README](README.md) dosyasında.
...
motoru yapar. Emeği geçenler ve lisanslar: [README](README.md#teşekkürler) ·
